...
public class HttpClientHelper {
     ...
     */
    public static String httpClientPost(String url, Map<String, String> headers, Map<String, String> urlParams, String body, String charset) {
        StringBuffer resultBuffer = null;
