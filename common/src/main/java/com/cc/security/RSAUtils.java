...
public class RSAUtils {
    ...
    public static Map<String, String> genKeyPair() {
        ...
        try {
            // 使用Base64对公钥加密得到字符串
            String publicKeyString = /*Base64Utils*/org.apache.commons.codec.binary.Base64.encodeBase64String(publicKey.getEncoded());
            publicKeyString = new Base64().encodeAsString(publicKey.getEncoded());

            // 使用Base64对私钥加密得到字符串
            String privateKeyString = /*Base64Utils*/org.apache.commons.codec.binary.Base64.encodeBase64String(privateKey.getEncoded());
    ...
    public static void main(String[] args) {
        ...
        String publicKey = getPublicKey(stringStringMap);
        String privateKey = getPrivateKey(stringStringMap);
